...
function ChartManager(container, config) {
...
(function (window, undefined) {
	...
	ChartManager.prototype = {
		init: function (container, config) {
			...
			chart.element.addEventListener("wheel", onWheel.bind(undefined, this));
			
			new Draggable(chart.element).on("dragmove", onDrag.bind(this));
		},
